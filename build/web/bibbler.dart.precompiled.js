...
["bibbler", "bibbler.dart", , F, {
  "^": "",
  main: [function() {
    new F.GameManager(4, 8, F.KeyboardInputManager$(), new F.HTMLActuator(document.querySelector(".tile-container"), document.querySelector(".score-container"), document.querySelector(".best-container"), document.querySelector(".game-message"), document.querySelector(".score-sharing"), 0), new F.LocalStorageManager("bestScore", window.localStorage), F.DictionaryManager$(), null, null, null, null, null, null, []).GameManager$1(4);
  }, "call$0", "main$closure", 0, 0, 1],
  DictionaryManager: {
    "^": "Object;scrabbleLetters,words",
    handleError$1: [function(error) {
      return window.alert("Error initializing words: " + H.S(error));
    }, "call$1", "get$handleError", 2, 0, 11],
    hasWord$1: function(tiles) {
      var t1, letterList;
      for (t1 = new H.ListIterator(tiles, tiles.length, 0, null), letterList = ""; t1.moveNext$0();)
        letterList += t1._current.get$$char().toLowerCase();
      return J.contains$1$asx(this.words, letterList);
    },
    randomLetter$0: function() {
      var letterIndex, t1, letter;
      letterIndex = C.C__JSRandom.nextInt$1(this.scrabbleLetters.length);
      t1 = this.scrabbleLetters;
      if (letterIndex < 0 || letterIndex >= t1.length)
        return H.ioore(t1, letterIndex);
      letter = t1[letterIndex];
      this.scrabbleLetters = H.stringReplaceFirstUnchecked(t1, letter, "");
      return letter;
    },
    DictionaryManager$0: function() {
      var t1, t2, t3;
      t1 = W.HttpRequest_getString("src/words.json", null, null).then$1(new F.DictionaryManager_closure(this));
      t2 = this.get$handleError();
      t3 = $.Zone__current;
      t2 = P._registerErrorHandler(t2, t3);
      t3.toString;
      t1._addListener$1(H.setRuntimeTypeInfo(new P._Future(0, t3, null, null, null, null, t2, null), [null]));
    },
    static: {DictionaryManager$: function() {
        var t1 = new F.DictionaryManager("AAAAAAAAABBCCDDDDEEEEEEEEEEEEFFGGGHHIIIIIIIIIJKLLLLMMNNNNNNOOOOOOOOPPQRRRRRRSSSSTTTTTTUUUUVVWWXYYZ", []);
        t1.DictionaryManager$0();
        return t1;
      }}
  },
  DictionaryManager_closure: {
    "^": "Closure:11;this_0",
  ...
  GameManager: {
    "^": "Object;size,startTiles,inputManager,actuator,storageManager,dictionary,grid,score,bestScore,over,won,continuing,currentTiles",
    submit$0: [function(_) {
      var t1, tile, t2, t3, t4;
      if (this.dictionary.hasWord$1(this.currentTiles) === true)
        for (t1 = this.currentTiles, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
          tile = t1._current;
          t2 = this.grid.cells;
          ...
          t4[t2] = null;
          t2 = this.score;
          t3 = J.$mul$ns(t3.get$value(tile), this.currentTiles.length);
          if (typeof t2 !== "number")
            return t2.$add();
          if (typeof t3 !== "number")
            return H.iae(t3);
    ...
    addStartTiles$0: function() {
      var t1, x, y, t2, tile, t3;
      for (t1 = this.dictionary, x = 0; x < this.size; ++x)
        for (y = 2; t2 = this.size, y <= t2; ++y) {
          tile = F.Tile$(new F.Cell(x, t2 - y), t1.randomLetter$0());
          t2 = this.grid.cells;
          t3 = tile.x;
    ...
    addTile$1: function(position) {
      var tile, t1, t2;
      tile = F.Tile$(position, this.dictionary.randomLetter$0());
      t1 = this.grid.cells;
      t2 = tile.x;
    ...
    move$1: function(direction) {
      var vector, traversals, t1, cell, tile, x, t2, y, t3, farthest, t4, t5, t6;
      vector = H.fillLiteralMap([0, new F.Cell(0, -1), 1, new F.Cell(1, 0), 2, new F.Cell(0, 1), 3, new F.Cell(-1, 0)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)).$index(0, direction);
      ...
      for (t1 = traversals.x, t1 = new H.ListIterator(t1, t1.length, 0, null), cell = null, tile = null; t1.moveNext$0();) {
        ...
        for (t2 = traversals.y, t2 = new H.ListIterator(t2, t2.length, 0, null); t2.moveNext$0();) {
          ...
          t3 = this.grid;
          t3.toString;
          if (J.$ge$n(x, 0) && J.$lt$n(x, t3.size) && J.$ge$n(y, 0) && J.$lt$n(y, t3.size)) {
            t3 = t3.cells;
            ...
            tile = null;
          if (tile != null) {
            farthest = this.findFarthestPosition$2(cell, vector);
            t3 = this.grid.cells;
            ...
            if (t3 >>> 0 !== t3 || t3 >= t4.length)
              return H.ioore(t4, t3);
            t4[t3] = tile;
            tile.updatePosition$1(farthest);
          }
        }
      }
      if (this.grid.availableCells$0().length === 0)
        this.over = true;
      t1 = this.storageManager;
      ...
      t3 = this.score;
      if (this.over !== true)
        t4 = this.won === true && this.continuing !== true;
      else
        t4 = true;
      this.actuator.actuate$5(t2, t3, t1, t4, this.won);
    },
    select$1: [function(_, tag) {
      var cell, tile, t1, t2, t3;
      cell = this.toCell$1(tag);
      ...
      if (t1.length >= 1) {
        ...
        t1 = !(J.abs$0$n(J.$sub$n(t2.get$x(tile), t3.get$x(t1))) <= 1 && J.abs$0$n(J.$sub$n(t2.get$y(tile), t3.get$y(t1))) <= 1);
      } else
        t1 = false;
      if (t1)
        return;
      if (C.JSArray_methods.contains$1(this.currentTiles, tile))
        for (; C.JSArray_methods.contains$1(this.currentTiles, tile);) {
          ...
          t1 = ".position-" + H.S(J.$add$ns(t2.get$x(t1), 1)) + "-" + H.S(J.$add$ns(t2.get$y(t1), 1));
    ...
    }, "call$1", "get$select", 2, 0, 13],
    toCell$1: function(tag) {
      var x, y;
      x = 0;
      while (true) {
        if (typeof tag !== "number")
          return tag.$mod();
        if (!(C.JSNumber_methods.$mod(tag, 2) === 0))
          break;
        ++x;
        tag /= 2;
      }
      for (y = 0; C.JSNumber_methods.$mod(tag, 3) === 0;) {
        ++y;
        tag /= 3;
      }
      return new F.Cell(x, y);
    },
    buildTraversals$1: function(vector) {
      var traversals, pos, listx, t1, listy;
      ...
      if (J.$eq(vector.x, 1)) {
        listx = [];
        for (t1 = H.setRuntimeTypeInfo(new H.ReversedListIterable(traversals.x), [null]), t1 = new H.ListIterator(t1, t1.get$length(t1), 0, null); t1.moveNext$0();)
          listx.push(t1._current);
        traversals.x = listx;
      }
      if (J.$eq(vector.y, 1)) {
        listy = [];
        for (t1 = H.setRuntimeTypeInfo(new H.ReversedListIterable(traversals.y), [null]), t1 = new H.ListIterator(t1, t1.get$length(t1), 0, null); t1.moveNext$0();)
          listy.push(t1._current);
        traversals.y = listy;
      }
      return traversals;
    },
    findFarthestPosition$2: function(cell, vector) {
      var t1, t2, cell0, t3;
      do {
        t1 = J.$add$ns(cell.x, vector.x);
        t2 = J.$add$ns(cell.y, vector.y);
        cell0 = new F.Cell(t1, t2);
        t3 = this.grid;
        t3.toString;
        if (J.$ge$n(t1, 0) && J.$lt$n(t1, t3.size) && J.$ge$n(t2, 0) && J.$lt$n(t2, t3.size)) {
          t3 = this.grid;
          t3.toString;
          if (J.$ge$n(t1, 0) && J.$lt$n(t1, t3.size) && J.$ge$n(t2, 0) && J.$lt$n(t2, t3.size)) {
            t3 = t3.cells;
    ...
    GameManager$1: function(size) {
      var t1 = this.inputManager;
      t1.on$2(0, "submit", this.get$submit(this));
      t1.on$2(0, "restart", this.get$restart());
      t1.on$2(0, "keepPlaying", this.get$keepPlaying());
      t1.on$2(0, "select", this.get$select(this));
      this.setup$0();
    }
  },
  Traversal: {
  ...
  Grid: {
    ...
    randomAvailableCell$0: function() {
      ...
      t1 = cells.length;
      if (t1 !== 0) {
        t1 = C.C__JSRandom.nextInt$1(t1);
        if (t1 < 0 || t1 >= cells.length)
          return H.ioore(cells, t1);
        return cells[t1];
      }
    ...
    withinBounds$1: function(position) {
      return J.$ge$n(position.x, 0) && J.$lt$n(position.x, this.size) && J.$ge$n(position.y, 0) && J.$lt$n(position.y, this.size);
    },
    ...
    static: {Grid_Grid: function(param) {
        return F.Grid$empty(param);
      }, Grid$empty: function(size) {
        var t1 = new F.Grid(size, null);
  ...
  HTMLActuator: {
    "^": "Object;tileContainer,scoreContainer,bestContainer,messageContainer,sharingContainer,score",
    actuate$5: function(cells, score, bestScore, terminated, won) {
      C.Window_methods.get$animationFrame(window).then$1(new F.HTMLActuator_actuate_closure(this, cells, score, bestScore, terminated, won));
    },
    clearContainer$1: function(container) {
      ...
      for (container.toString; t1 = new W._ChildNodeListLazy(container), t1.get$isNotEmpty(t1);) {
        ...
        new W._ChildNodeListLazy(container).remove$1(0, result);
      }
    },
    addTile$1: function(tile) {
      var inner, t1, t2, wrapper, classTag, result, t3;
      inner = document.createElement("div", null);
      J.get$classes$x(inner).add$1(0, "tile-inner");
      ...
      inner.id = C.JSNumber_methods.toString$0(t1 * Math.pow(3, t2));
      wrapper = document.createElement("div", null);
      wrapper.appendChild(inner);
      t1 = J.getInterceptor$x(wrapper);
      t1.get$classes(wrapper).add$1(0, "tile");
      t2 = tile.previousPosition;
      if (t2 != null) {
        classTag = "position-" + H.S(J.$add$ns(t2.x, 1)) + "-" + H.S(J.$add$ns(t2.y, 1));
        t1.get$classes(wrapper).add$1(0, classTag);
        t1 = C.Window_methods.get$animationFrame(window);
        t2 = $.Zone__current;
        t2.toString;
        result = new P._Future(0, t2, null, null, new F.HTMLActuator_addTile_closure(this, tile, wrapper, classTag), null, P._registerErrorHandler(null, t2), null);
        ...
        t2 = tile.x;
        t3 = tile.y;
        t1.add$1(0, "position-" + H.S(J.$add$ns(t2, 1)) + "-" + H.S(J.$add$ns(t3, 1)));
        t1.add$1(t1, "tile-new");
      }
      this.tileContainer.appendChild(wrapper);
    },
    toClassTag$1: function(position) {
      return "position-" + H.S(J.$add$ns(position.x, 1)) + "-" + H.S(J.$add$ns(position.y, 1));
    },
    toggleSelection$1: function(position) {
      var t1 = J.getInterceptor$x(position);
      t1 = ".position-" + H.S(J.$add$ns(t1.get$x(position), 1)) + "-" + H.S(J.$add$ns(t1.get$y(position), 1));
      J.get$classes$x(document.querySelector(t1)).toggle$1("tile-selected");
    }
  },
  HTMLActuator_actuate_closure: {
    "^": "Closure:11;this_0,cells_1,score_2,bestScore_3,terminated_4,won_5",
    call$1: function(_) {
      var t1, t2, t3, cell, t4, difference, addition, type, message;
      t1 = this.this_0;
      t1.clearContainer$1(t1.tileContainer);
      for (t2 = this.cells_1, t2 = new H.ListIterator(t2, t2.length, 0, null); t2.moveNext$0();)
        for (t3 = J.get$iterator$ax(t2._current); t3.moveNext$0();) {
          cell = t3.get$current();
          if (cell != null)
            t1.addTile$1(cell);
        }
      t2 = this.score_2;
      t3 = t1.scoreContainer;
      t1.clearContainer$1(t3);
      t4 = t1.score;
      if (typeof t2 !== "number")
        return t2.$sub();
      difference = t2 - t4;
      t1.score = t2;
      t3.textContent = C.JSNumber_methods.toString$0(t2);
      if (difference > 0) {
        addition = document.createElement("div", null);
        J.get$classes$x(addition).add$1(0, "score-addition");
        addition.textContent = "+" + C.JSNumber_methods.toString$0(difference);
        t3.appendChild(addition);
      }
      t1.bestContainer.textContent = J.toString$0(this.bestScore_3);
      if (this.terminated_4) {
        t2 = this.won_5 === true;
        type = t2 ? "game-won" : "game-over";
        message = t2 ? "You win!" : "Game over!";
        t1 = t1.messageContainer;
        J.get$classes$x(t1).add$1(0, type);
        t1.querySelector("p").textContent = message;
      }
    }
  },
  HTMLActuator_addTile_closure: {
    "^": "Closure:11;this_0,tile_1,wrapper_2,classTag_3",
    call$1: function(_) {
      var t1, t2;
      t1 = J.get$classes$x(this.wrapper_2);
      t1.remove$1(0, this.classTag_3);
      t2 = this.tile_1;
      t1.add$1(t1, this.this_0.toClassTag$1(new F.Cell(t2.x, t2.y)));
    }
  },
  KeyboardInputManager: {
    ...
    on$2: function(_, eventTag, callback) {
      var t1 = this.events;
      if (!t1.containsKey$1(0, eventTag))
        t1.$indexSet(0, eventTag, []);
      t1.$index(0, eventTag).push(callback);
    },
    restart$1: [function($event) {
      J.preventDefault$0$x($event);
      this.emit$1("restart");
    }, "call$1", "get$restart", 2, 0, 11],
    keepPlaying$1: [function($event) {
      J.preventDefault$0$x($event);
      this.emit$1("keepPlaying");
    }, "call$1", "get$keepPlaying", 2, 0, 11],
    emit$2: function(eventTag, data) {
      var t1, callbacks, t2, callback;
      t1 = this.events;
      if (t1.containsKey$1(0, eventTag)) {
        callbacks = t1.$index(0, eventTag);
        for (t1 = new H.ListIterator(callbacks, callbacks.length, 0, null), t2 = data != null; t1.moveNext$0();) {
    ...
    KeyboardInputManager$0: function() {
      var t1, t2;
      t1 = H.setRuntimeTypeInfo(new W._EventStream(document, C.EventStreamProvider_keydown._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new F.KeyboardInputManager_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = C.EventStreamProvider_click._eventType;
      t2 = H.setRuntimeTypeInfo(new W._EventStream(document, t1, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new F.KeyboardInputManager_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = this.get$restart();
      H.setRuntimeTypeInfo(new W._ElementListEventStreamImpl(W._FrozenElementList$_wrap(document.querySelectorAll(".retry-button"), null), false, t1), [null]).listen$1(t2);
      t2 = this.get$restart();
      H.setRuntimeTypeInfo(new W._ElementListEventStreamImpl(W._FrozenElementList$_wrap(document.querySelectorAll(".restart-button"), null), false, t1), [null]).listen$1(t2);
      t2 = this.get$keepPlaying();
      H.setRuntimeTypeInfo(new W._ElementListEventStreamImpl(W._FrozenElementList$_wrap(document.querySelectorAll(".keep-playing-button"), null), false, t1), [null]).listen$1(t2);
    },
    static: {KeyboardInputManager$: function() {
        var t1 = new F.KeyboardInputManager(H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
        t1.KeyboardInputManager$0();
        return t1;
      }}
  },
  KeyboardInputManager_closure: {
    "^": "Closure:14;this_0",
  ...
  KeyboardInputManager_closure0: {
    "^": "Closure:15;this_1",
    call$1: function($event) {
      var t1, tag;
      t1 = J.getInterceptor$x($event);
      if (J.get$className$x(t1.get$target($event)) === "tile-inner") {
        tag = J.get$id$x(t1.get$target($event));
        t1.preventDefault$0($event);
        this.this_1.emit$2("select", H.Primitives_parseInt(tag, null, null));
      }
    }
  },
  LocalStorageManager: {
    "^": "Object;BEST_SCORE_KEY,storage",
  ...
  Tile: {
    "^": "Object;x>,y>,value>,$char<,previousPosition,selected',scrabbleValues",
    ...
    Tile$2: function(position, $char) {
      ...
      this.x = position.x;
      this.y = position.y;
      this.value = this.scrabbleValues.$index(0, t1);
      this.previousPosition = null;
    },
    static: {Tile$: function(position, $char) {
...
["dart.async", "dart:async", , P, {
  ...
  _BroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 16, 4],
    close$0: function(_) {
      var t1, doneFuture;
      t1 = this._state;
      if ((t1 & 4) !== 0)
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 16, 4]
  },
  _SyncCompleter: {
    "^": "_Completer;future"
  },
...
function dart_precompiled($collectedClasses) {
  ...
  function DictionaryManager(scrabbleLetters, words) {
    this.scrabbleLetters = scrabbleLetters;
    this.words = words;
  }
  DictionaryManager.builtin$cls = "DictionaryManager";
  if (!"name" in DictionaryManager)
    DictionaryManager.name = "DictionaryManager";
  $desc = $collectedClasses.DictionaryManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DictionaryManager.prototype = $desc;
  function DictionaryManager_closure(this_0) {
    this.this_0 = this_0;
  }
  DictionaryManager_closure.builtin$cls = "DictionaryManager_closure";
  if (!"name" in DictionaryManager_closure)
    DictionaryManager_closure.name = "DictionaryManager_closure";
  $desc = $collectedClasses.DictionaryManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DictionaryManager_closure.prototype = $desc;
  function GameManager(size, startTiles, inputManager, actuator, storageManager, dictionary, grid, score, bestScore, over, won, continuing, currentTiles) {
    this.size = size;
  ...
  function HTMLActuator_actuate_closure(this_0, cells_1, score_2, bestScore_3, terminated_4, won_5) {
    this.this_0 = this_0;
    this.cells_1 = cells_1;
    this.score_2 = score_2;
    this.bestScore_3 = bestScore_3;
    this.terminated_4 = terminated_4;
    this.won_5 = won_5;
  }
  ...
  function HTMLActuator_addTile_closure(this_0, tile_1, wrapper_2, classTag_3) {
    this.this_0 = this_0;
    this.tile_1 = tile_1;
    this.wrapper_2 = wrapper_2;
    this.classTag_3 = classTag_3;
  }
  ...
  function KeyboardInputManager_closure(this_0) {
    this.this_0 = this_0;
  }
  KeyboardInputManager_closure.builtin$cls = "KeyboardInputManager_closure";
  if (!"name" in KeyboardInputManager_closure)
    KeyboardInputManager_closure.name = "KeyboardInputManager_closure";
  $desc = $collectedClasses.KeyboardInputManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyboardInputManager_closure.prototype = $desc;
  function KeyboardInputManager_closure0(this_1) {
    this.this_1 = this_1;
  }
  KeyboardInputManager_closure0.builtin$cls = "KeyboardInputManager_closure0";
  if (!"name" in KeyboardInputManager_closure0)
    KeyboardInputManager_closure0.name = "KeyboardInputManager_closure0";
  $desc = $collectedClasses.KeyboardInputManager_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyboardInputManager_closure0.prototype = $desc;
